...
# Encontrar as 10 viagens mais caras
# Mostrar cargo, destino e valor
# Calcular o valor médio das viagens
# Ver quantas viagens custaram mais que a média
...
# Encontrar as 10 viagens mais caras mostrando cargo, destino e valor
...
# Calcular o valor médio das viagens caras

valor_medio_viagens = viagens_mais_caras['Despesas'].mean()
print(valor_medio_viagens)

# Ver quantas viagens custaram mais que a média das viagens caras
